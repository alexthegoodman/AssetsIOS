...
export default class AssetRank extends Component {
    ...
    render() {
        ...
        let total = 0, count = 0, average, averageRank, rankList, firstname, lastname, thisUser, thisUserHash, icon, disable = true;
        ...
        if (!isNaN(average)) {
            disable = false;
            icon = <View style={styles.averageRankIcon}><Down width={20} height={20} color="#595959" /></View>
        ...
        return (
            <View style={[styles.assetRankBody, { height: this.state.rankHeight } ]}>
                <TouchableHighlight disabled={disable} activeOpacity={1} underlayColor="#E5E5E5" onPress={this.toggleRankings} style={styles.averageRank}>
